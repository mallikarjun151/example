#ifndef lint
static char Sccs_id[] = "@(#)$Id: fm_mks_pol_config.c /cgbubrm_7.5.0.portalbase/1 2015/11/27 05:32:52 nishahan Exp $";
#endif
...
#ifdef WIN32
__declspec(dllexport) void * fm_mks_pol_config_func();
#endif
 ...
 *******************************************************************/
struct cm_fm_config fm_mks_pol_config[] = {
